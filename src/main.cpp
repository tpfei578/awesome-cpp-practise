...
// configuration step. It creates a namespace called `awesome-cpp-practise`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        awesome-cpp-practise::cmake::project_name,
        awesome-cpp-practise::cmake::project_version));// version string, acquired
